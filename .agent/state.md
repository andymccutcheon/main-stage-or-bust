...
- Handoff directive `REFINEMENT-DIRECTIVE.md` written (net-new, supersedes by consolidation; v6/v7 kept as history). Engine-verified tables; flags pre-existing DESIGN/engine venue drift as P0 to reconcile.
## Open Work (ranked)
